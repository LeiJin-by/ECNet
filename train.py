...
def evaluate(name, data, folds=10, device='cuda:0'):
    pre_test_y = []
    for i in range(folds):
        pre_test_y_i = predict_ensemble('models', name, i, data, device=device)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--folds", type=int, default=5,
                        help="Number of folds for training ECNet, default: 5")
    ...
    if performance_test:
        pre_test, performance = evaluate(name, test_X, folds=folds, device=device)
