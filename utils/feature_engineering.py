...
def ECNet_fea(formulas, max_elements=15):
    ...
    electron_config_df = pd.read_csv(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'elec_config.csv'))
    electron_np = electron_config_df.iloc[:, 1:-1].values.astype('float32')  
